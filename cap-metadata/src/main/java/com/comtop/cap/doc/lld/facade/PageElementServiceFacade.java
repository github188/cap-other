 ...
 */
@DocumentService(name = "PageElementService", dataType = PageElementServiceDTO.class)
public class PageElementServiceFacade extends AbstractExportFacade<PageElementServiceDTO> {
    
    @Override
    public List<PageElementServiceDTO> loadData(PageElementServiceDTO condition) {
