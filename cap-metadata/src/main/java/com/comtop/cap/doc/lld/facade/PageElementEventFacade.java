 ...
 */
@DocumentService(name = "PageElementEvent", dataType = PageElementEventDTO.class)
public class PageElementEventFacade extends AbstractExportFacade<PageElementEventDTO> {
    
    @Override
    public List<PageElementEventDTO> loadData(PageElementEventDTO condition) {
