...
import com.comtop.cap.doc.lld.model.APIOutputDTO;
 ...
 */
@DocumentService(name = "APIOutput", dataType = APIOutputDTO.class)
public class APIOutputFacade extends AbstractExportFacade<APIOutputDTO> {
    
    @Override
    public List<APIOutputDTO> loadData(APIOutputDTO condition) {
