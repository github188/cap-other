 ...
 */
public class BizObjectConverter {
    
    /**
     * 构造函数
     */
    private BizObjectConverter() {
        //
    }
     ...
     * @return 节点DTO
     */
    public static BizObjectDTO convert2Package(BizObjectDTO bizFormDTO, WordDocument document) {
        BizObjectDTO packageDTO = new BizObjectDTO();
