...
public class LoaderUtilTest {
    ...
    /** 测试文件上传后存放的路径 */
    private String folderPath = "/EMF_TEST";
    ...
    public void testUpload() {
        LoaderUtil.upLoad(LoaderUtilTest.class.getClassLoader().getResourceAsStream(uploadPath + "/image35.emf"),
            folderPath, "image35.emf");
        // LoaderUtil.upLoad(LoaderUtilTest.class.getClassLoader().getResourceAsStream(uploadPath + "/test_图片.gif"),
        // folderPath, "test_图片.gif");
        // LoaderUtil.upLoad(LoaderUtilTest.class.getClassLoader().getResourceAsStream(uploadPath + "/test_图片.png"),
        // folderPath, "test_图片.png");
    }
