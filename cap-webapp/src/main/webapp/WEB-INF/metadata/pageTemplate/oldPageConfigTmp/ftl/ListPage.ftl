				...
				<#if dataStoreList.pageConstant??>
						,{
							...
							"constantOption":{
								...
								"pageModelId":"${dataStoreList.pageConstant.pageModelId}EditPage",
								"url":"${dataStoreList.pageConstant.url}EditPage${pageUrlSuffix}"
							},
							"constantType":"url",
							"constantValue":"'${dataStoreList.pageConstant.url}EditPage${pageUrlSuffix}'"
						},
						{
	...
	"pageActionVOList":[
		...
		<#-- grid初始化查询行为 -->
		{
			...
			"methodOption":{
				...
				"methodId":"${queryEntityId}/queryVOListByPage",
