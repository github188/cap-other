				...
				<#if dataStoreList.pageConstant??>
					{
						...
						"constantOption":{
							"pageAttributeVOList":"[]",
							"pageModelId":"${dataStoreList.pageConstant.pageModelId}ListPage",
							"url":"${dataStoreList.pageConstant.url}ListPage${pageUrlSuffix}"
						},
						"constantType":"url",
						"constantValue":"'${dataStoreList.pageConstant.url}ListPage${pageUrlSuffix}'"
					}
					<#-- 列表链接变量 -->
	...
	"pageComponentExpressionVOList":[
		<#-- 循环状态集合-->
		{
			...
			"pageComponentStateList":[
				...
				{
					"componentId":"uiid-770882131694816",
					"hasValidate":false,
					"state":"hide"
				},
				{
					"componentId":"uiid-5975074970861897",
					"hasValidate":false,
					"state":"hide"
				}
			]
