{
			...
			<#if dataStoreList??>
				...
				<#if dataStoreList.pageConstant??>
						,{
							...
							"constantName":"${dataStoreList.pageConstant.constantName}EditPage",
							"constantOption":{
								...
								"pageModelId":"${dataStoreList.pageConstant.pageModelId}EditPageForWorkFlow",
								"url":"${dataStoreList.pageConstant.url}EditPageForWorkFlow${pageUrlSuffix}"
							},
							"constantType":"url",
							"constantValue":"'${dataStoreList.pageConstant.url}EditPageForWorkFlow${pageUrlSuffix}'"
						},
						{
							"constantDescription":"查看页面",
							"constantName":"${dataStoreList.pageConstant.constantName}ViewPage",
							"constantOption":{
								"pageAttributeVOList":"[{\"attributeName\":\"primaryValue\",\"attributeDescription\":\"primaryValue\",\"attributeValue\":\"\"},{\"attributeName\":\"pageMode\",\"attributeDescription\":\"页面模式\",\"attributeValue\":\"\"}]",
								"pageModelId":"${dataStoreList.pageConstant.pageModelId}EditPageForWorkFlow",
								"url":"${dataStoreList.pageConstant.url}EditPageForWorkFlow${pageUrlSuffix}"
						...
						<#-- 编辑链接变量 -->
						<#assign editURLConstant= dataStoreList.pageConstant.constantName+"EditPage">
						<#-- 查看链接变量 -->
						<#assign viewURLConstant= dataStoreList.pageConstant.constantName+"ViewPage">
					<#else>
						<#-- 编辑链接变量 -->
	...
	"pageActionVOList":[
		...
		{
			"cname":"加载grid数据",
			"description":"重新加载grid数据",
			"ename":"reloadGridData",
			"methodBody":"",
			"methodBodyExtend":{
				"before":""
			},
			...
			"methodTemplate":"actionlibrary.pageRefresh.action.loadData",
			"pageActionId":"1448356843985"
		}
		<#-- 循环判断是否增加列渲染方法 -->
		<#if gridRender??>
