...
function nodeUrl(nodeId){
	var url = "EntityMethodSelList.jsp?entityModelId=" + nodeId + "&nodeType=app";
...
function treeClick(node){
	...
	var nodeType = "app";
	if(data.data.modelType  && data.data.modelType == "entity"){
		nodeType = "entity";
	}
	var url = "EntityMethodSelList.jsp?entityModelId=" + data.data.modelId + "&nodeType=" + nodeType;
	cui('#body').setContentURL("center", url);	
}
