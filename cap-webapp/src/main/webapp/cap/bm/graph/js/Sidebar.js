...
{
	this.addPalette('general', mxResources.get('general'), expand, mxUtils.bind(this, function(content)
	{
		content.appendChild(this.createVertexTemplate('swimlane', 200, 200, ''));
		content.appendChild(this.createVertexTemplate('swimlane;horizontal=0', 200, 200, ''));
	    content.appendChild(this.createVertexTemplate('text', 40, 26, 'Text'));
	    content.appendChild(this.createVertexTemplate('icon;image=' + this.gearImage, 60, 60, ''));
	    content.appendChild(this.createVertexTemplate('label;image=' + this.gearImage, 140, 60, ''));
