...
<head>
    ...
    <script type="text/javascript">
    	...
    	function openAWindow(){
    		window.open ('openwindow3.jsp','newwindow3','height=600,width=800,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no')
    	}
    </script>
</head>
<body>
     <button onclick="getIframeChildrenPageDate()">从open子页面2上去取数据</button>
