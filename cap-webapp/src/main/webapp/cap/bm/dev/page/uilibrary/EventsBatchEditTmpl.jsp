...
<!-- 控件事件模版 -->
<script id="eventBatchEditTmpl" type="text/template">
<!---
...
-->
			    ...
			    <tr <!--- if (event.hide === true){ --> style="display:none" <!--- } --> >
					<td>
						<table class="form_table">
							<tr>
								<td align="left" nowrap="nowrap"><input type="checkbox" value="0" readonly="readonly" ng-model="batchEditProperties.+-event.ename-+"/>+-event.ename-+</tb>
							...
							<tr>
								<td>
									<span cui_clickinput id="+-event.ename-+" ng-model="+-ngModel-+" ng-click="openSelectAction('+-event.ename-+')" methodTemplate="+-event.methodTemplate-+" methodOption="+-event.methodOption-+" actionType="+-event.type-+"></span>
								</td>
								<td align="right">
		...
		-->
			<table><tr><td width="auto" nowrap="nowrap">&nbsp;&nbsp;<a class="notUnbind show-more row-of-icons" ng-click="switchHideArea('hasHideNotCommonEvents')"><span class="cui-icon">{{!hasHideNotCommonEvents?'&#xf0d7;&nbsp;收起':'&#xf0da;&nbsp;更多'}}&nbsp;</span></a></td><td width='185px'><hr></td></tr></table>
		<!---
			} else {
				break;
			}
