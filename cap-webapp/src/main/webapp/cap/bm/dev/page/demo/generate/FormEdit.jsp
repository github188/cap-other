...
<head>
	...
	<top:script src='/cap/dwr/interface/FormEditAction.js'></top:script>
	<top:script src='/cap/dwr/interface/CapWorkflowAction.js'></top:script>
	<top:script src='/cap/rt/common/workflow/common/js/userSelect/json2.js'></top:script>
    ...
    <script type="text/javascript">
		...
		cap.rt10.workflow.config.remoteObject= CapWorkflowAction; 
		//cap.rt10.workflow.config.workflowFacadeName = 'form';
	  	
		//cap.rt.workflow.config.remoteObject=FormEditAction;
		//cap.rt.workflow.config.validateMethod=function(chooseData){
		//		return check(chooseData);
		//	};
		...
		/* function getBizData(){
        	...
        	{
	        	uitype:'Inputxxx',
	            databind:'data.workPlanIdxx',
	        	name:'workPlanIdxx',
	        	readonly: true 
        	}];
		}
		
		function check(chooseData){
			alert(chooseData);
			return chooseData[0];
			//return undefined;
		}  */
        ...
        function pageInitLoadData(){
        	...
        	FormEditAction.readFormById("123",function(data1){
        		//数据设置前操作
         ...
         */
         function entryOne(){
        	 cap.rt10.workflow.config.getBizflowDataMethod = function(){
	        	var entryData = [];
	        	if(cap.validateForm()){
	         		cap.beforeSave();
	        		entryData[0] = objectAttr;
	        	}
        		return entryData;
        	};
	        //cap.rt10.workflow.config.submitData = entryData;
	        cap.rt10.workflow.config.operateCallBack = function(result){
	        	cui.message('**保存成功！', 'success');
	        	var url = '/web/cap/bm/dev/page/demo/generate/formList.ac';
	        ...
	        cap.rt10.workflow.config.remoteObject = CapWorkflowAction;
	        cap.rt10.workflow.operate.report();
        }
         ...
         */
         function save(){
        	...
        	if(cap.validateForm()){
        		...
        		FormEditAction.insertForm(data,function(data1){
        			//赋值前操作
		...
		<table class="cap-table-fullWidth">
		    <tr>
		        ...
		        <td class="cap-td" style="text-align: right;">
		        	...
		        	<span id="entry" uitype="Button"></span>
