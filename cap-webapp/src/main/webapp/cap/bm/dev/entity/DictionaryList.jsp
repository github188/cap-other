...
<title>配置项列表</title>
    ...
    <top:script src="/top/sys/js/comtop.ui.emDialog.js"></top:script>
<style type="text/css">
.validImg {
	cursor: pointer;
...
<div class="list_header_wrap">
	...
	<div class="top_float_right"  style="padding-right: 5px;padding-bottom: 10px">
		...
		<span uitype="button" id="selected" label="确定" button_type="blue-button" on_click="selectOne"></span>
...
function selectOne(){
	...
	window.parent.parent.dictionaryCallBack(selectData[0]);
}

//取消选择
function cancelSelect(){
	window.parent.parent.selectDictionaryDialog.hide();
}
//清空选择
function clearData(){
	window.parent.parent.clearDataCallBack();
}
</script>
</body>
</html>
