		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false" >
			...
			<div class="carousel-inner " >
				<div class="item active" >
					<img src="images/scriptImagehelp1.png"  class="img-responsive center-block">
					<div class="carousel-caption" ><font color="red" style="font-size: 20px;font-weight: bold;">函数定义</font></div>
				</div>
				<div class="item" >
					<img src="images/scriptImagehelp2.png" class="img-responsive center-block">
					<div class="carousel-caption"><font color="red" style="font-size: 20px;font-weight: bold;">函数方法体编写及自定义属性引入</font></div>
				</div>
				<div class="item" >
					<img src="images/scriptImagehelp3.png" class="img-responsive center-block">
					<div class="carousel-caption"><font color="red" style="font-size: 20px;font-weight: bold;" >插入可编写脚本</font></div>
				</div>
			</div>
