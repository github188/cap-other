...
if(window.gbWhVer&&window.gbWhLang&&window.gbWhMsg&&window.gbWhUtil&&window.gbWhHost&&window.gbWhProxy)
{
	...
	goIdxFont=new whFont("ËÎÌו","9pt","#000000","normal","normal","none");
	goIdxEmptyFont=new whFont("ËÎÌו","9pt","#666666","normal","normal","none");
	goIdxHoverFont=new whFont("ËÎÌו","9pt","#007f00","normal","normal","underline");
