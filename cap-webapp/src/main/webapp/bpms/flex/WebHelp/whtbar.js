...
function addSearchForm()
{
	...
	else if("image"=="image"&&gsIGo)
	{
		...
		sButton+="<img alt=\"转至\" src=\""+gsIGo+"\" border=0 align=\"absmiddle\"></a></td>";
	}
	sButton+="</tr></table>";
	if(gbNav6)
		sButton+="</form>";
...
if(window.gbWhUtil&&window.gbWhMsg&&window.gbWhVer&&window.gbWhProxy)
{
	...
	goTextFont=new whFont("宋体","9pt","#003063","normal","normal","none");
	goSelTextFont=new whFont("宋体","9pt","white","normal","normal","none");
	gbWhTBar=true;
}
else
	document.location.reload();
