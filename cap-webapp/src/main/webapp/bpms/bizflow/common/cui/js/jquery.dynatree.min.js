	...
	DynaTree.prototype = {
		...
		_load: function(callback) {
			...
			this.cache = {
				...
				tagExpander: "<span class='cui-icon tree-icon-expanded " + opts.classNames.expander + "'>&#xf0d7;</span>" +
                    "<span class='cui-icon tree-icon-unexpanded " + opts.classNames.expander + "'>&#xf0da;</span>",
