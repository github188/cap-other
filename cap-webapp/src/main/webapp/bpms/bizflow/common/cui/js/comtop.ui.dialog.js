...
(function (win) {
    ...
    Dialog.prototype = {
        ...
        _buildHTML: function () {
            ...
            if (op.canClose) {
                html.push('<a href="#" title="关闭" class="dialog-close-btn cui-icon">&#xf00d;<!--span class="dialog-close-btn-span"></span--></a>');
            }
        ...
        _bindEvent: function () {
            var op = this.opt,
                self = this;
            this._$dialogContainer.delegate("a.cui-button,span.dialog-close-btn-span,a.dialog-close-btn", "click", function (e) {
        ...
        _buildButtons: function () {
            ...
            for(var i= 0,len=op.buttons.length;i<len;i++){
                ...
                var button= op.buttons[i], classzz = "cui-button ";
        ...
        _showOverLay: function () {
            ...
            if (isIE6 || isIEQ) {
                ...
                if(this._$iframecover.length){
                    this._$iframecover.appendTo(doc.body).show();
                }
            }
            this._$overlay.css("opacity", this.opt.opacity).appendTo(doc.body).show();
        },
        /**
         * 隐藏遮罩层
         * @private
        ...
        show: function (src) {
            ...
            this._setPosition();
            this._showOverLay();
            this._$dialogContainer.appendTo(doc.body).show();
