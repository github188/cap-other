...
<script type="text/javascript">
	...
	var initBoxData=[];
	 //管辖范围
    var rootId = "<c:out value='${param.rootOrgId}'/>";
	   //标准岗位id
	...
	*/
	function setEditUrl(orgStructureId,parentNodeId,orgId,orgName){
		...
		var url = "${pageScope.cuiWebRoot}/top/sys/post/PostSelectList.jsp?" + "orgId="+orgId+"&orgName="+orgName+"&associateType="+associateType+"&postId="+postId;
		if(rootId == null){
			url += "&isAdmin=no";
		}
