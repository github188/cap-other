...
<body>
	...
	<table id="grid" uitype="grid" pagesize_list="[10,20,30]" datasource="dataProvider" primarykey="POST_ID" colrender="columnRenderer" resizewidth="resizeWidth"  resizeheight="resizeHeight" >
		<tr>
			...
			<th bindName="POST_NAME" style="width:25%" sort="true" renderStyle="text-align: left" >岗位名称</th>
			<th bindName="ORG_NAME" style="width:25%" sort="true" renderStyle="text-align: left" >所属组织</th>
			<th bindName="POST_CODE" style="width:25%" sort="true" renderStyle="text-align: left" >岗位编码</th>
			<th bindName="POST_CLASSIFY" style="width:20%" sort="true" renderStyle="text-align: left" >岗位类别</th>
		</tr>
	</table>
...
<script language="javascript">
	...
	function dataProvider(tableObj,query){
		...
		RoleAction.queryPostListByRoleId(condition, function(data){
			dataList = data.list;
