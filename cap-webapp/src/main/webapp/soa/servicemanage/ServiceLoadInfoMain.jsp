  ...
  $.ajax({
       ...
       success: function(data,status){
           ...
           if(!checkStrEmty(treeData)){
                  ...
                  var  url = '<cui:webRoot/>/soa/servicemanage/ServiceLoadInfoList.jsp?sysCode=root&sysName=';
...
function treeClick(node){
    ...
    var  url = '<cui:webRoot/>/soa/servicemanage/ServiceLoadInfoList.jsp?sysCode='+sysCode;
