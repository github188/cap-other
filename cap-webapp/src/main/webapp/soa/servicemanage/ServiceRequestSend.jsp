		...
		<table class="form_table" style="table-layout:fixed;">
	        ...
	        <tr>
	         ...
	         <tr>
	            ...
	            <td><span uitype="Textarea" id="inputArgs" width="658px" databind="oldData.inputArgs" height="180px"></span></td>	
	        </tr>
	         <tr>
	            <td class="td_label">响应报文：</td>
	            <td><span uitype="Textarea" id="invokeResult" width="658px" id="invokeResult" height="180px"></span></td>	
	        </tr>
		</table>
	</div>
</div>
<script type="text/javascript">
        ...
        var logId="${param.logId}";
           ...
           function testWsdlConnectivity(){
            ...
            var	reqAddr=oldData.reqAddr.split("/soa/cxf")[0];
            var sysCode=oldData.sysCode;
            if (checkStrEmty(sysCode)){
            	sysCode="";
            }
            operType="doRequestService";
            cui('#testWsdl').disable(true);
            cui('#invokeResult').setValue("正在执行请求...");
           	var url = '<cui:webRoot/>/soa/SoaServlet/doRequest?operType='+operType+'&reqAddr='+reqAddr+'&sysCode='+sysCode+'&sid='+sid+'&timeStamp='+ new Date().getTime();
           	//采用ajax请求提交
               $.ajax({
                    type: "POST",
                    url: url,
