 ...
 * 复制、修改或发布本软件.
 *****************************************************************************/
package com.comtop.budget.action.abs;
 ...
 */
public abstract class AbstractUserListPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/budget/userListPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/budget/UserListPageForWorkFlow.jsp";
	}
}