 ...
 */
public abstract class AbstractUserEditPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/budget/userEditPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/budget/UserEditPageForWorkFlow.jsp";
	}
}