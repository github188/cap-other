 ...
 * @param <T> 类泛型参数
 */
public abstract class AbstractXcPresententryAppService<T extends XcPresententryVO> extends CapBaseAppService<XcPresententryVO> {
