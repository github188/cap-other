 ...
 * @author CAP超级管理员
 * @since 1.0
 * @version 2016-7-29 CAP超级管理员
 */
public abstract class AbstractAgainTestListPageForWorkFlowAction extends BaseAction {
	 ...
	 */
	@InOut
	protected String userId="SuperAdmin";
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/againTestListPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/AgainTestListPageForWorkFlow.jsp";
	}
}