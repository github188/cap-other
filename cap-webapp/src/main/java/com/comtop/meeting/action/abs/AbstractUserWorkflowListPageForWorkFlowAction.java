 ...
 */
@DwrProxy
public abstract class AbstractUserWorkflowListPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/userWorkflowListPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/UserWorkflowListPageForWorkFlow.jsp";
	}
}