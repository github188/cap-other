 ...
 * @author CAP超级管理员
 * @since 1.0
 * @version 2016-5-27 CAP超级管理员
 */
public abstract class AbstractOtcWorkflowListPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/otcWorkflowListPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/OtcWorkflowListPageForWorkFlow.jsp";
	}
}