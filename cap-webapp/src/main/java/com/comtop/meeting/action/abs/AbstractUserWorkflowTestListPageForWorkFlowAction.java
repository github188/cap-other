...
@DwrProxy
@MadvocAction
public abstract class AbstractUserWorkflowTestListPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/userWorkflowTestListPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/UserWorkflowTestListPageForWorkFlow.jsp";
	}
}