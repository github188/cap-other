 ...
 */
public abstract class AbstractOtcWorkflowToDoListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/otcWorkflowToDoListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/OtcWorkflowToDoListPage.jsp";
	}
}