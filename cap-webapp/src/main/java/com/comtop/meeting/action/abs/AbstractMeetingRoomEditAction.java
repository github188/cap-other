 ...
 * @author 作者
 * @version jdk1.6
 * @version 2016-2-22 作者
 */
@DwrProxy
@MadvocAction
public abstract class AbstractMeetingRoomEditAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/meetingRoomEdit.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/MeetingRoomEdit.jsp";
	}
}