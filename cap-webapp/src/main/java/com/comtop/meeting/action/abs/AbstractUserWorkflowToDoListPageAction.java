 ...
 */
@DwrProxy
public abstract class AbstractUserWorkflowToDoListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/userWorkflowToDoListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/UserWorkflowToDoListPage.jsp";
	}
}