 ...
 */
@DwrProxy
public abstract class AbstractUserWorkflowDoneListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/userWorkflowDoneListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/UserWorkflowDoneListPage.jsp";
	}
}