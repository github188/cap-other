 ...
 */
@DwrProxy
public abstract class AbstractOtcWorkflowEditPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/otcWorkflowEditPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/OtcWorkflowEditPageForWorkFlow.jsp";
	}
}