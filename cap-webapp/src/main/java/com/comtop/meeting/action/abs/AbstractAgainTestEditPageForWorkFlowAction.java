 ...
 */
@DwrProxy
public abstract class AbstractAgainTestEditPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/againTestEditPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/AgainTestEditPageForWorkFlow.jsp";
	}
}