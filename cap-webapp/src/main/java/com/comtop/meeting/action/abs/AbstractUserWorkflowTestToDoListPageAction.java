...
@DwrProxy
@MadvocAction
public abstract class AbstractUserWorkflowTestToDoListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/userWorkflowTestToDoListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/UserWorkflowTestToDoListPage.jsp";
	}
}