 ...
 * @author CAP超级管理员
 * @since 1.0
 * @version 2016-9-6 CAP超级管理员
 */
public abstract class AbstractAgainTestDoneListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/againTestDoneListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/AgainTestDoneListPage.jsp";
	}
}