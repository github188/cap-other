 ...
 * @author CAP超级管理员
 * @since 1.0
 * @version 2016-6-28 CAP超级管理员
 */
public abstract class AbstractAgainTestToDoListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/againTestToDoListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/AgainTestToDoListPage.jsp";
	}
}