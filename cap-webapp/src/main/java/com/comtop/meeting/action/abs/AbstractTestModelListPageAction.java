 ...
 * @author CAP超级管理员
 * @since 1.0
 * @version 2016-4-4 CAP超级管理员
 */
@DwrProxy
public abstract class AbstractTestModelListPageAction extends BaseAction {
	...
	//初始化权限变量
		readPermission = verify("meeting_testModelListPage", "readPermission");
	}
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/testModelListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/TestModelListPage.jsp";
	}
}