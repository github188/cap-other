...
@DwrProxy
@MadvocAction
public abstract class AbstractEeeTestModelListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/eeeTestModelListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/EeeTestModelListPage.jsp";
	}
}