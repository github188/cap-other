 ...
 */
@DwrProxy
public abstract class AbstractTestCustomTestModelListPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/testCustomTestModelListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/TestCustomTestModelListPage.jsp";
	}
}