...
@DwrProxy
@MadvocAction
public abstract class AbstractUserWorkflowTestEditPageForWorkFlowAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/meeting/userWorkflowTestEditPageForWorkFlow.ac")
	public String pageInit() {
		initPageAttr();
		return "/meeting/UserWorkflowTestEditPageForWorkFlow.jsp";
	}
}