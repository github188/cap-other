 ...
 */
public class Romexception extends CapBaseException {
     ...
     * @param params 参数
     */
    public Romexception(String message, Object... params) {
     ...
     * @param params 异常信息参数
     */
    public Romexception(String message, Throwable throwable, Object... params) {
