 ...
 */
public abstract class AbstractBizAccountListPageAction extends BaseAction {
	 ...
	 */
    @InOut
    protected List<BizaccountVO> bizaccountList;
	 ...
	 * @return 页面URL
	 */
	@Action("/carstorage/bizAccountListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/carstorage/BizAccountListPage.jsp";
	}
}