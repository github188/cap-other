 ...
 */
public abstract class AbstractTreeStorageListPageAction extends BaseAction {
	 ...
	 */
    @InOut
    protected List<CarstorageVO> carstorageList;
	 ...
	 * @return 页面URL
	 */
	@Action("/carstorage/treeStorageListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/carstorage/TreeStorageListPage.jsp";
	}
}