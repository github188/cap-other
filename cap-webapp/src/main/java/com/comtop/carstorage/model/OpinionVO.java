...
public class OpinionVO extends CapBaseVO {
     ...
     */
    public Integer getIsglobalctrl() {
        return isglobalctrl;
    }
     ...
     */
    public void setIsglobalctrl(Integer isglobalctrl) {
    ...
    /**
     * @return 获取 refBizAccount 属性值
     */
    public String getRefBizAccount() {
        return refBizAccount;
    }
    	
    /**
     * @param refBizAccount 设置 refBizAccount 属性值为参数值 refBizAccount
     */
    public void setRefBizAccount(String refBizAccount) {
        this.refBizAccount = refBizAccount;
    }
