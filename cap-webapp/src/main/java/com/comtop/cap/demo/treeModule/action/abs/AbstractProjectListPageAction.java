 ...
 */
public abstract class AbstractProjectListPageAction extends BaseAction {
	 ...
	 */
    @InOut
    protected List<JerryProjectVO> jerryProjectList;
	 ...
	 * @return 页面URL
	 */
	@Action("/cap/demo/treeModule/projectListPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/cap/demo/treeModule/ProjectListPage.jsp";
	}
}