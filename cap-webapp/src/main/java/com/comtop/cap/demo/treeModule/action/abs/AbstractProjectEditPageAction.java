 ...
 */
public abstract class AbstractProjectEditPageAction extends BaseAction {
	 ...
	 * @return 页面URL
	 */
	@Action("/cap/demo/treeModule/projectEditPage.ac")
	public String pageInit() {
		initPageAttr();
		return "/cap/demo/treeModule/ProjectEditPage.jsp";
	}
}