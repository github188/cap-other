...
import com.comtop.cap.demo.treeModule.action.abs.AbstractProjectListPageAction;
...
@DwrProxy
@MadvocAction
public class ProjectListPageAction extends AbstractProjectListPageAction {
