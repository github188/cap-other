 ...
 */
@PetiteBean
public class FormDeleteTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        objRetMap.put("tableId", getLayoutIdByType(objPageVO, "Grid"));
        objRetMap.put("rIndexes", "[0,1]");
        objRetMap.put("locator-delBtn", "id=" + getActionIdByActionType(objPageVO, "delete"));
        return objRetMap;
    }
