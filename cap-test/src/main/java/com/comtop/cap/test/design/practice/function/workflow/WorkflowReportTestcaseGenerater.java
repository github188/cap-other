 ...
 */
@PetiteBean
public class WorkflowReportTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        objRetMap.put("locator-reportBtn", "id=" + this.getActionIdByActionType(objPageVO, "report"));
        objRetMap.put("report-text", "失败:0单");// TODO
        return objRetMap;
    }
