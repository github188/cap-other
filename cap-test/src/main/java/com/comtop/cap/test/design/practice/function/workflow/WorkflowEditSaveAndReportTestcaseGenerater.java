 ...
 */
@PetiteBean
public class WorkflowEditSaveAndReportTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        objRetMap.put("locator-btnAdd", "id=" + this.getActionIdByActionType(objLstPageVO, "insert"));
        ...
        String strReportId = this.getActionIdByActionType(objPageVO, "editSaveAndReport");
        objRetMap.put("locator-saveAndReportBtn", "id=" + strReportId);
        objRetMap.put("report-text", "操作成功！");// TODO
        // EGrid组件数据录入处理
