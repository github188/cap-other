 ...
 */
@PetiteBean
public class FormUpdateTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        String strKey = PageUITypeEnum.TO_ENTRY_LIST_PAGE.getPageUIType() + objPageVO.getModelName();
        ...
        objRetMap.put("tableId", getLayoutIdByType(objLstPageVO, "Grid"));
        objRetMap.put("row", "1");
        ...
        objRetMap.put("locator-btnSave", "id=" + getActionIdByActionType(objPageVO, "save"));
        objRetMap.put("save-text", getAcitonOptionValueByOptionName(objPageVO, "save", "successMessage"));
        // EGrid组件数据录入处理
