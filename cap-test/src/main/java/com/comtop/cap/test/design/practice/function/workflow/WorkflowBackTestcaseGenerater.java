 ...
 */
@PetiteBean
public class WorkflowBackTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        objRetMap.put("locator-home", "title=" + objCapPackageVO.getModuleName() + "-" + getChineseSystemName());
        ...
        objRetMap.put("locator-backBtn", "id=" + this.getActionIdByActionType(objPageVO, "back"));
        objRetMap.put("back-text", "失败:0单");// TODO
        return objRetMap;
    }
