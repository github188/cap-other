 ...
 */
@PetiteBean
public class WorkflowSendTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        objRetMap.put("locator-sendBtn", "id=" + this.getActionIdByActionType(objPageVO, "send"));
        objRetMap.put("send-text", "失败:0单");// TODO
        return objRetMap;
    }
