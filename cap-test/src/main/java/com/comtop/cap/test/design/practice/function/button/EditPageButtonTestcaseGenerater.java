 ...
 */
@PetiteBean
public class EditPageButtonTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        String strKey = PageUITypeEnum.LIST_PAGE.getPageUIType() + objPageVO.getModelName();
        List<PageVO> lstPageVOPath = (List<PageVO>) objMap.get(strKey);
        if (lstPageVOPath == null) {
            strKey = PageUITypeEnum.TO_ENTRY_LIST_PAGE.getPageUIType() + objPageVO.getModelName();
            lstPageVOPath = (List<PageVO>) objMap.get(strKey);
        }
        if (lstPageVOPath == null) {
            strKey = PageUITypeEnum.ENTRYED_LIST_PAGE.getPageUIType() + objPageVO.getModelName();
            lstPageVOPath = (List<PageVO>) objMap.get(strKey);
        }
        if (lstPageVOPath == null) {
            strKey = PageUITypeEnum.TODO_LIST_PAGE.getPageUIType() + objPageVO.getModelName();
            lstPageVOPath = (List<PageVO>) objMap.get(strKey);
        }
        if (lstPageVOPath == null) {
            strKey = PageUITypeEnum.DONE_LIST_PAGE.getPageUIType() + objPageVO.getModelName();
            lstPageVOPath = (List<PageVO>) objMap.get(strKey);
        }
