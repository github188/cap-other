 ...
 */
@PetiteBean
public class WorkflowEditReportTestcaseGenerater extends AbstractFunctionTestcaseGenerater {
    ...
    public Map<String, Object> wrapperArgs(PageVO objPageVO, String strLayoutId) {
        ...
        objRetMap.put("locator-reportBtn", "id=" + this.getActionIdByActionType(objPageVO, "editReport"));// 编辑页面元数据的上报按钮ID
